...
I am a Ph.D. candidate at Beihang University, working on **generative modeling for spatial omics**.
...
### soScope — Lateral resolution enhancement

A generative framework modeling spatial omics measurements as **aggregated observations of latent cellular states**.

- Variational inference formulation of spatial aggregation  
- Unified modeling of histology and gene expression  
...
- Continuous modeling of biological structures  
- Reconstruction from sparse serial sections  
...
Framework for transferring molecular annotations to histological images.

- Cross-scale alignment between omics and imaging  
- Model design and system integration  
